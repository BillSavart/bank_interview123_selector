...
export function AboutPage() {
  return (
    <div className="container py-4 about-page">
      ...
      <p className="about-text">
        <Link to="/venues">試場資訊</Link>彙整各家銀行招考的試場情報：頁面上方是<strong>試場地圖</strong>，下方分成筆試與面試兩種資料——筆試統計各試場的缺考人數，面試則整理各試場的考題與考驗重點。
      </p>
      <ol className="about-list">
        <li>試場地圖標出台北市與新北（板橋、中和、永和）各家公股銀行招考常用的考場，標記依分區上色並編號；點地圖標記或右側清單可看地址、最近捷運站與路線，並一鍵在 Google 地圖開啟導航。</li>
